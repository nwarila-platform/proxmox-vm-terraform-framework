...
[![PR Validation](https://github.com/nwarila-platform/proxmox-vm-terraform-framework/actions/workflows/pr-validation.yaml/badge.svg?branch=main)](https://github.com/nwarila-platform/proxmox-vm-terraform-framework/actions/workflows/pr-validation.yaml)
...
| Linting | `tflint` (full Terraform ruleset for the bpg/proxmox module) |
| Security | `trivy` (HIGH/CRITICAL misconfigs + CVEs), `gitleaks` (secret detection), `zizmor` (Actions posture) |
...
| CI/CD | GitHub Actions reusable validation, security, release, and docs workflows |
| Dependency mgmt | Renovate (GitHub Actions, Terraform, tooling, weekly) |
...
| [terraform-docs](https://terraform-docs.io/) | `= 0.23.0` | Documentation generation |
...
|   |-- workflows/               # CI, release, docs, and security workflows
|   |-- CODEOWNERS
|   `-- PULL_REQUEST_TEMPLATE.md
|-- .vscode/                     # VS Code workspace settings and tasks
|-- docs/                        # MkDocs source and generated references
|-- examples/                    # Usage examples
|-- policies/opa/                # OPA plan policies and tests
|-- terraform/                   # Core Terraform configuration and tests
|-- tools/                       # Documentation, version, and OPA helpers
|-- .editorconfig
|-- .gitignore
|-- .pre-commit-config.yaml
|-- .terraform-docs.yml          # terraform-docs output config
|-- .tflint.hcl                  # TFLint full Terraform ruleset
|-- Makefile
|-- CHANGELOG.md
|-- CONTRIBUTING.md
|-- LICENSE
...
- **GitHub Actions**: managed automatically by Renovate
